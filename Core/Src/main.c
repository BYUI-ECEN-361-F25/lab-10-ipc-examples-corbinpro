...
/* Definitions for SemaphoreTogD3 */
osThreadId_t SemaphoreTogD3Handle;
const osThreadAttr_t SemaphoreTogD3_attributes = {
  .name = "SemaphoreTogD3",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for ResetMutex */
osThreadId_t ResetMutexHandle;
const osThreadAttr_t ResetMutex_attributes = {
  .name = "ResetMutex",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
int main(void)
{
  ...
  /* creation of SemaphoreTogD3 */
  SemaphoreTogD3Handle = osThreadNew(Semaphore_Toggle_D3, NULL, &SemaphoreTogD3_attributes);

  /* creation of ResetMutex */
  ResetMutexHandle = osThreadNew(Reset_MutexCount, NULL, &ResetMutex_attributes);
...
/**
* @brief Function implementing the SemaphoreTogD3 thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the ResetMutex thread.
* @param argument: Not used
* @retval None
*/
